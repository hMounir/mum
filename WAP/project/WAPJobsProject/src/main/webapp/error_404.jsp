            ...
            <div class="flex-fill">
                ...
                <div class="row">
                    <div class="col-xl-4 offset-xl-4 col-md-8 offset-md-2">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <a href="index.jsp" class="btn btn-primary btn-block"><i class="icon-home4 mr-2"></i> Dashboard</a>
                            </div>
                        </div>
                        <!-- /buttons -->
        ...
        <div class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="navbar-collapse collapse" id="navbar-footer">
					<span class="navbar-text">
						&copy; 2019. <a href="#">MUM Project</a> by <a href="http://www.linkedin.com/in/hmounir" target="_blank">Hisham Mounir</a> &
                        <a href="https://www.facebook.com/mnhamed" target="_blank">Mohamed Nabil</a>
					</span>
            </div>
        </div>
        <!-- /footer -->
